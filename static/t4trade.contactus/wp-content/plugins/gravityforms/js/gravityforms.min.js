...
gform.recaptcha = {
    ...
    function(u, g) {
        u.uploaders = {};
        var m = "undefined" != typeof gform_gravityforms ? gform_gravityforms.strings : {},
            _ = "undefined" != typeof gform_gravityforms ? gform_gravityforms.vars.images_url : "";

        function i(o) {
            var f, r, e = g(o).data("settings"),
                t = new plupload.Uploader(e);

            function d(e, t) {
                g("#" + e).prepend("<li>" + p(t) + "</li>"), setTimeout(function() {
                    wp.a11y.speak(g("#" + e).text())
                }, 1e3)
            }

            function a(e) {
                var t = parseInt(e.gf_vars.max_files, 10);
                0 < t && (t = t <= i(e.multipart_params.field_id), u.toggleDisabled(e, t), t || (t = e.gf_vars.message_id, e = m.max_reached, g("#" + t + " li:contains('" + e + "')").remove()))
            }

            function l() {
                var e = g("#gform_uploaded_files_" + f).val();
                return e = void 0 === e || "" === e ? {} : g.parseJSON(e)
            }
            ...
            f = t.settings.multipart_params.form_id, (u.uploaders[e.container] = t).bind("Init", function(e, t) {
                var r, i, n;
                e.features.dragdrop || g(".gform_drop_instructions").hide(), r = e.settings.container, i = r.querySelectorAll('input[type="file"]')[0], n = r.querySelectorAll(".gform_button_select_files")[0], r = g(o).closest(".gfield").find(".gfield_label")[0], i && r && n && (r.setAttribute("for", i.id), n.setAttribute("aria-label", n.innerText.toLowerCase() + ", " + r.innerText.toLowerCase()), i.setAttribute("tabindex", "-1"), i.setAttribute("aria-hidden", "true")), a(e.settings)
            }), u.toggleDisabled = function(e, t) {
                ("string" == typeof e.browse_button ? g("#" + e.browse_button) : g(e.browse_button)).prop("disabled", t)
                ...
                r = g.secureEvalJSON(r.response);
                "error" == r.status ? (e.removeFile(t), d(e.settings.gf_vars.message_id, t.name + " - " + r.error.message), g("#" + t.id).html("")) : e.settings.multipart_params[t.target_name] = r.data
            }), t.bind("FileUploaded", function(e, t, r) {
                if (e.getFile(t.id)) {
                    var i = g.secureEvalJSON(r.response);
                    if ("error" == i.status) return d(e.settings.gf_vars.message_id, t.name + " - " + i.error.message), g("#" + t.id).html(""), void a(e.settings);
                    var n = "<strong>" + p(t.name) + "</strong>",
                        o = e.settings.multipart_params.form_id,
                    ...
                    n = gform.applyFilters("gform_file_upload_markup", n, t, e, m, _, i), g("#" + t.id).html(n), 100 == t.percent && (i.status && "ok" == i.status ? (n = r, r = i.data, (i = s(n)).unshift(r), function(e, t) {
                        var r = l(),
                            i = g("#gform_uploaded_files_" + f),
                            e = c(e);
                        r[e] = t, i.val(g.toJSON(r))
                    }(n, i)) : d(e.settings.gf_vars.message_id, m.unknown_error + ": " + t.name))
                }
        ...
        function p(e) {
            return g("<div/>").text(e).html()
        }
        g(document).bind("gform_post_render", function(e, t) {
            g("form#gform_" + t + " .gform_fileupload_multifile").each(function() {
                i(this)
            });
            var r = g("form#gform_" + t);
            0 < r.length && r.submit(function() {
                var r = !1;
                if (g.each(u.uploaders, function(e, t) {
                        if (0 < t.total.queued) return !(r = !0)
                    }), r) return alert(m.currently_uploading), window["gf_submitting_" + t] = !1, g("#gform_ajax_spinner_" + t).remove(), !1
            })
        }), g(document).bind("gform_post_conditional_logic", function(e, t, r, i) {
            i || g.each(u.uploaders, function(e, t) {
                t.refresh()
            })
        }), g(document).ready(function() {
            "undefined" != typeof adminpage && "toplevel_page_gf_edit_forms" === adminpage || "undefined" == typeof plupload ? g(".gform_button_select_files").prop("disabled", !0) : "undefined" != typeof adminpage && -1 < adminpage.indexOf("_page_gf_entries") && g(".gform_fileupload_multifile").each(function() {
                i(this)
            })
        }), u.setup = function(e) {
            i(e)
